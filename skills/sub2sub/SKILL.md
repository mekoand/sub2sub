---
name: sub2sub
description: Review first-use settings, check or install sub2sub updates, share an execution node, connect with an invitation, delegate or continue tasks, adjust caller/provider settings, view saved results, query nodes and quota, manage connections, and clean or restore task work copies.
---
