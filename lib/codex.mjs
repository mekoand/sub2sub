...
export async function runCodex({ executable, workspace, temporaryDirectory, threadId, prompt, model, reasoningEffort, onThread, onProgress, signal }) {
  ...
  try {
    await request('initialize', { clientInfo: { name: 'sub2sub', version: '0.5.2' }, capabilities: { experimentalApi: true } });
