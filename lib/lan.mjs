...
export class Sharing {
  ...
  async open(input) {
    try {
      ...
      await writeJson(path.join(this.root, 'runtime.json'), { pid: process.pid, ...this.endpoint, host: '127.0.0.1', port: this.managementServer.address().port, token: this.localToken });
