...
import { Config, executionSettings, executionHarness, harnessSettings, allowedModels, retentionDays, deviceName, TASK_FILE_SCOPE } from './config.mjs';
    ...
    return {
      ...
      settings: {
        ...
        provider: {
          ...
          modelAvailability: 'unverified',
          limits: transferLimits(config.provider), retentionDays: retentionDays(config.provider)
        },
        advanced: {
