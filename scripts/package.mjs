...
for (const name of ['.codex-plugin', '.mcp.json', 'package.json', 'package-lock.json', 'node_modules', 'README.md', 'README.zh-CN.md', 'README.en.md', 'LICENSE', 'CHANGELOG.md', 'CONTRIBUTING.md', 'config.example.json', 'bin', 'lib', 'skills', 'install.sh', 'install.ps1']) {
